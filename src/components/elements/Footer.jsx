...
const Footer = () => {
  return (
    <footer className="flex w-full h-[800px] md:h-[700px] lg:h-[439px] bg-white">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 lg:gap-8 w-[327px] sm:w-[640px] md:w-[768px] lg:w-[1106px] lg:h-[250px] mx-auto mt-24">
        ...
        <div className="md:ml-8">
          ...
          <nav className="flex flex-row md:flex-col w-[327px] md:w-full justify-between h-[30px] md:h-[114px] text-darkest-grey tracking-wide md:mt-7">
            <img
        ...
        <div>
          ...
          <nav className="flex flex-row md:flex-col md:justify-between w-full h-[30px] md:h-[114px] text-darkest-grey tracking-wide mt-7">
